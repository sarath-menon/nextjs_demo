...
const HomePage = () => {
  return (
    ...
    <>
      {/* Hero */}
      <section
        className="flex flex-col relative justify-center items-center text-center px-4 sm:px-6 mb-16"
      >
        ...
        <div className="mt-8 max-w-[900px] sm:ml-0 rounded-2xl border-8 border-washed-purple-300 border-opacity-10">

          <Image src={"/projects-display.png"}
            alt="Banner"
      ...
      >
        ...
        <TitleSection
          title="All yoir work in one place"
          text="Capture your ideas, thoughts, and meeting notes in a structured and organized manner."
          pill="Features"
        />
